...
if (isset($_POST["masuk"])) {
    ...
    //select from tabel user
    $result = mysqli_query($conn, "SELECT * FROM users WHERE nisn='$nisn' AND password='$password'");
    //jika ada datanya
        ...
        <div class="row justify-content-center py-5">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="border-top card-body text-center mt-0">Belum mempunyai akun? <a href="register.php">Dafar akun</a>
                        <hr class="mx-auto mt-3 mw-2  " style="width: 180px;">
                        Login sebagai admin? <a class="mt-1" href="loginadmin.php">Login</a>
                    </div>
                </div> <!-- card.// -->
            </div> <!-- col.//-->
        </div> <!-- row.//-->
